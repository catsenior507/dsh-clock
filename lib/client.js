window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var clock_module_css_default = {
			...
			"forkActions": "_8SpRlq_forkActions",
			"forkBanner": "_8SpRlq_forkBanner",
			"form": "_8SpRlq_form",
		...
		*/
		...
		function ClockApp() {
			...
			*/
			...
			const answerFork = (0, react.useCallback)(async (path, forkSessionId) => {
				try {
			...
			return react.default.createElement(react.default.Fragment, null, !open ? null : react.default.createElement("div", {
				...
				title: "关闭"
			}, "✕")), react.default.createElement("div", { className: clock_module_css_default.body }, state === null || state.forks.length === 0 ? null : react.default.createElement("div", { className: clock_module_css_default.forkBanner }, state.forks.map((fork) => react.default.createElement("div", { key: fork.sessionId }, react.default.createElement("div", null, "「" + fork.title + "」是从「" + fork.parentTitle + "」分支出来的，还有 ", String(fork.alarms), " 条闹钟只指向原来那条对话 —— 那个分支不会被唤醒。"), react.default.createElement("div", { className: clock_module_css_default.forkActions }, react.default.createElement("button", {
				className: clock_module_css_default.smallButton,
				onClick: () => {
					answerFork("/alarms/fork-copy", fork.sessionId);
				}
			}, "复制闹钟到这个分支"), react.default.createElement("button", {
				className: clock_module_css_default.smallButton,
				onClick: () => {
					answerFork("/alarms/fork-dismiss", fork.sessionId);
				}
			}, "不用了"))))), react.default.createElement("div", { className: clock_module_css_default.clock }, react.default.createElement("div", { className: clock_module_css_default.clockTime }, formatTime(now, zone)), react.default.createElement("div", { className: clock_module_css_default.clockMeta }, react.default.createElement("div", { className: clock_module_css_default.clockDate }, formatDate(now, zone)), react.default.createElement("div", { className: clock_module_css_default.clockZone }, zone)), react.default.createElement("div", { className: clock_module_css_default.nextAlarm }, react.default.createElement("div", { className: clock_module_css_default.nextLabel }, "下一个唤醒"), nextPending === null ? react.default.createElement("div", { className: clock_module_css_default.nextValueIdle }, "无") : react.default.createElement("div", { className: clock_module_css_default.nextValue }, countdownText(nextPending.at - now)))), react.default.createElement("div", { className: clock_module_css_default.calendar }, react.default.createElement("div", { className: clock_module_css_default.calendarBar }, react.default.createElement("button", {
				className: clock_module_css_default.iconButton,
