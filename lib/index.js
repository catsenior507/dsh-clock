...
function apply(ctx, config) {
	...
	if (optionalService(ctx, "sessionController") === void 0) ctx.logger?.warn("[clock] sessionController unavailable: alarms can be created and listed, but waking is disabled");
